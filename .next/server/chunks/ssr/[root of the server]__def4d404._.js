...
async function addExam(exam) {
    const examsCol = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"], 'exams');
    return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addDoc"])(examsCol, exam);
}
async function updateExam(id, exam) {
    const examRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["doc"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"], 'exams', id);
    return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateDoc"])(examRef, exam);
}
...
async function addUser(user) {
    const usersCol = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"], 'users');
    return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addDoc"])(usersCol, user);
}
async function updateUser(id, user) {
    ...
    return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateDoc"])(userRef, user);
}
async function deleteUser(id) {
    const userRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["doc"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"], 'users', id);
    return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteDoc"])(userRef);
}
}}),
...
;
;
// Remove DUMMY_EXAMS. Exams will be fetched from Firestore.
// Remove DUMMY_USERS. Users will be fetched from Firestore.
...
function AdminDashboard() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        setLoading(true);
        Promise.all([
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firestore$2d$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchExams"])(),
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firestore$2d$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchUsers"])()
        ]).then(([examsData, usersData])=>{
            setExams(examsData);
            setUsers(usersData);
            setLoading(false);
        }).catch((err)=>{
    ...
    const [assignmentDueDate, setAssignmentDueDate] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const handleApproveReject = async (examId, status)=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firestore$2d$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateExam"])(examId, {
                reviewStatus: status
            });
    ...
    const handleAddUser = async ()=>{
        if (newEmail && !users.find((user)=>user.email === newEmail)) {
            ...
            try {
                const docRef = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firestore$2d$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addUser"])(newUser);
                setUsers([
                    ...users,
                    {
                        ...newUser,
                ...
                toast({
                    ...
                    description: `User ${newEmail} added as ${newRole}.`
                });
                addLog('User Added', `Admin ${user?.email} added user ${newEmail} as ${newRole}`);
            } catch (err) {
    ...
    const handleRemoveUser = async (userId)=>{
        ...
        try {
            ...
            if (removedUser) {
                addLog('User Removed', `Admin ${user?.email} removed user ${removedUser.email} (${removedUser.role})`);
            }
        } catch (err) {
    ...
    const handleChangeRole = async (userId, newRole)=>{
        ...
        try {
            ...
            if (updatedUser) {
                addLog('User Role Changed', `Admin ${user?.email} changed user ${updatedUser.email} role to ${newRole}`);
            }
        } catch (err) {
    ...
    const handleAssignExamsWithDueDate = ()=>{
        ...
        setUsers(users.map((user)=>{
            if (user.id === selectedInternForAssignment) {
                const assignedExams = [
                    ...user.assignedExams,
                    ...selectedExamsForAssignment
                ];
                addLog('Exams Assigned', `Admin ${user?.email} assigned exams ${selectedExamsForAssignment.join(', ')} to intern ${user.email} with due date ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(assignmentDueDate, 'PPP')}`);
                return {
                    ...user,
                    assignedExams
                };
    ...
    if (loading) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: "Loading data from Firestore..."
    }, void 0, false, {
        fileName: "[project]/src/app/admin/page.tsx",
        lineNumber: 297,
        columnNumber: 23
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__def4d404._.js.map