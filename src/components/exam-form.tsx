...
export default function ExamForm({ examId }: ExamFormProps) {
      ...
      try {
        ...
        if (strategy.shouldFillMainExam) {
          ...
          if (autoFillData) {
            ...
            if (strategy.shouldFillSubExams && autoFillData.subExams && autoFillData.subExams.length > 0) {
              setSubExams(autoFillData.subExams);
              console.log('Auto-filled specific sub-exam:', autoFillData.subExams[0].sub_exam_name);
            } else {
              console.log('Main exam info auto-filled. Sub-exams left for manual selection.');
            }
  ...
  const handleEducationRequirementChange = (
    ...
    const newSubExams = [...subExams];
    (newSubExams[subExamIndex].educationRequirements[eduIndex] as any)[field] = value;
    setSubExams(newSubExams);
  };
      ...
      <Card className="max-w-6xl mx-auto">
        <CardHeader className="pb-4">
          ...
          <CardDescription className="text-sm">
            ...
            {isAutoFillLoading && (
              <span className="ml-2 text-blue-600">Loading assignment data...</span>
            )}
            {autoFillApplied && examId && (
              <span className="ml-2 text-green-600">
                ✓ Auto-filled for {examId.includes('-') ? 'specific exam assignment' : 'main exam category'}
              </span>
            )}
          </CardDescription>
        </CardHeader>
          ...
          {isAutoFillLoading ? (
            <div className="flex items-center justify-center py-8">
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">Loading exam information...</p>
              </div>
            </div>
          ) : (
            <Form {...form}>
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-3">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-sm font-medium">Main Exam Name</FormLabel>
                        <FormControl>
                          <Input
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-sm font-medium">Exam Code</FormLabel>
                        <FormControl>
                          <Input placeholder="e.g., UPSC_CSE_2025" className="h-9" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-sm font-medium">Conducting Body</FormLabel>
                        <Select
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-sm font-medium">Exam Sector</FormLabel>
                        <Select
                          onValueChange={field.onChange}
                          defaultValue={field.value}
                        >
                ...
                {(watchConductingBody === "Other" || watchExamSector === "Other") && (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-3">
                    {watchConductingBody === "Other" && (
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-sm font-medium">Custom Conducting Body</FormLabel>
                            <FormControl>
                              <Input
                    ...
                    {watchExamSector === "Other" && (
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-sm font-medium">Custom Exam Sector</FormLabel>
                            <FormControl>
                              <Input
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mt-3">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-sm font-medium">Website Link</FormLabel>
                        <FormControl>
                          <Input
                            type="url"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="w-full">
                        ...
                        <Select
                          ...
                          onValueChange={(value) =>
                            handleSubExamChange(index, "marital_status", value)
                          }
                        >
                          <SelectTrigger className="w-full">
                                ...
                                <FormControl>
                                  <div className="grid grid-cols-2 gap-2 border p-3 rounded-md">
                                    {disabilityOptions.map((disability) => {
                                      const isChecked = (field.value as string[] || []).includes(disability);
                                      return (
                                        <div key={disability} className="flex items-center space-x-2">
                                          <Checkbox
                                            ...
                                            onCheckedChange={(checked) => {
                                              ...
                                              if (checked) {
                                                field.onChange([...currentValues, disability]);
                                              } else {
                                                field.onChange(currentValues.filter((val) => val !== disability));
                                              }
                                            }}
                                          />
                          ...
                          (requirement, eduIndex) => (
                            ...
                            >
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                {/* Level */}
                                <div className="w-full">
                                  <Label htmlFor={`level_${index}_${eduIndex}`}>
                                    Level
                                  </Label>
                                  <Select
                              ...
                              <FormControl>
                                <div className="grid grid-cols-2 gap-2 border p-3 rounded-md">
                                  {nationalityOptions.map((nationality) => {
                                    const isChecked = (field.value as string[] || []).includes(nationality);
                                    return (
                                      <div key={nationality} className="flex items-center space-x-2">
                                        <Checkbox
                                          ...
                                          onCheckedChange={(checked) => {
                                            const currentValues = field.value as string[] || [];
                                            if (checked) {
                                              field.onChange([...currentValues, nationality]);
                                            } else {
                                              field.onChange(currentValues.filter((val) => val !== nationality));
                                            }
                                          }}
                                        />
                                        <label className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
                              ...
                              <FormControl>
                                <div className="grid grid-cols-2 gap-2 border p-3 rounded-md">
                                  {domicileOptions.map((domicile) => {
                                    const isChecked = (field.value as string[] || []).includes(domicile);
                                    return (
                                      <div key={domicile} className="flex items-center space-x-2">
                                        <Checkbox
                                          checked={isChecked}
                                          onCheckedChange={(checked) => {
                                            const currentValues = field.value as string[] || [];
                                            if (checked) {
                                              field.onChange([...currentValues, domicile]);
                                            } else {
                                              field.onChange(currentValues.filter((val) => val !== domicile));
                                            }
                                          }}
                                        />
                                        <label className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
                              ...
                              <FormControl>
                                <div className="grid grid-cols-2 gap-2 border p-3 rounded-md">
                                  {languageOptions.map((language) => {
                                    const isChecked = (field.value as string[] || []).includes(language);
                                    return (
                                        ...
                                        <Checkbox
                                          ...
                                          onCheckedChange={(checked) => {
                                            ...
                                            if (checked) {
                                              ...
                                              field.onChange(currentValues.filter((val) => val !== language));
                                            }
                                          }}
                                        />
                                        <label className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
              ...
              <div className="mt-4 p-4 bg-blue-50 rounded-lg">
                ...
                <Button 
                  ...
                  onClick={async () => {
                    ...
                    if (result) {
                      alert('Auto-fill test successful! Check console for details.');
                    } else {
                      alert('Auto-fill test failed. Check console for errors.');
                    }
                  }}
                  className="mr-2"
                >
